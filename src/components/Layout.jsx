  ...
  const navigation = [
    { name: 'Dashboard', href: '/', icon: Home },
    {
      ...
      children: [
        ...
        { name: 'Live Account Setup', href: '/account-setup/live' },
        { name: 'Item Setup', href: '/item-setup' },
        { name: 'Live Item Setup', href: '/item-setup/live' },
        { name: 'Listings', href: '/listing' },
        { name: 'Live Listing Review', href: '/listing/live' },
        { name: 'Pricing', href: '/pricing' },
        { name: 'Live Pricing Review', href: '/pricing/live' },
        { name: 'Transaction', href: '/flow', phase: 'Live Operations' },
        { name: 'Live Transaction Risk', href: '/transaction/live' },
        { name: 'Payment', href: '/payment/live' },
        { name: 'Payout', href: '/payout' },
        { name: 'Live Payout Review', href: '/payout/live' },
        { name: 'Shipping', href: '/shipping' },
        { name: 'Live Shipping Review', href: '/shipping/live' },
        { name: 'Returns', href: '/returns' },
        { name: 'Live Return Review', href: '/returns/live' },
        { name: 'ATO', href: '/ato', phase: 'Security' },
        { name: 'Live ATO Detection', href: '/ato/live' },
        { name: 'Profile Updates', href: '/profile-updates' },
        { name: 'Live Profile Review', href: '/profile-updates/live' },
        { name: 'Compliance', href: '/compliance/live', phase: 'Extended' },
        { name: 'Network Intelligence', href: '/network/live' },
        { name: 'Review Integrity', href: '/review/live' },
        { name: 'Behavioral Analytics', href: '/behavioral/live' },
        { name: 'Buyer Trust', href: '/buyer-trust/live' },
        { name: 'Policy Enforcement', href: '/policy/live' },
        { name: 'Seller Journey', href: '/seller-journey', phase: 'Cross-Domain' }
      ]
    },
    {
