...
router.get('/', async (req, res) => {
  try {
    ...
    let records = db_ops.getAll('review_checks') || [];
...
router.get('/stats', async (req, res) => {
  try {
    const records = db_ops.getAll('review_checks') || [];
...
router.get('/:id', async (req, res) => {
  try {
    const record = db_ops.getById('review_checks', 'check_id', req.params.id);
    if (!record) {
...
router.post('/', async (req, res) => {
  try {
    ...
    db_ops.insert('review_checks', 'check_id', checkId, record);
    ...
    agent.reason(
      ...
      .then(agentResult => {
        ...
        db_ops.update('review_checks', 'check_id', checkId, {
          ...record,
          status: decision,
          riskScore,
          riskAssessment: {
...
router.patch('/:id/status', async (req, res) => {
  try {
    ...
    db_ops.update('review_checks', 'check_id', req.params.id, updated);
