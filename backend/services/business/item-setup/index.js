...
router.post('/', (req, res) => {
  try {
    ...
    if (req.body.restrictedCategory) {
      riskScore += 50;
      riskFactors.push('restrictedCategory');
    }
    if (req.body.weightAnomaly) {
      riskScore += 15;
      riskFactors.push('weightAnomaly');
    }
    if (req.body.duplicateProduct) {
      riskScore += 25;
      riskFactors.push('duplicateProduct');
    }
    if (!req.body.complianceData) {
      riskScore += 10;
      riskFactors.push('missingComplianceData');
    }
